...
export class BuildersController {
  ...
  findOne(@Param('id') id: string) {
    return this.buildersService.getByIdBuilder(id);
  }

  @Patch(':id')
  update(@Param('id') id: string, @Body() updateBuilderDto: UpdateBuilderDto) {
    return this.buildersService.updateByIdBuilder(+id, updateBuilderDto);
  }

  @Delete(':id')
  remove(@Param('id') id: string) {
    return this.buildersService.deleteBuilder(+id);
  }
}
